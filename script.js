...
function setSlide() {
    ...
    ctx.shadowColor = "rgba(190,190,190,0.54)";
    ...
    switch(currentSlide) {
        ...
        case 1:
            ...
            break;
        case 2:
            fillSlide("How is it created?",
                "Neural networks are used to train and ");
            break;
        default:
...
function fillSlide(title, l1, l2="", l3="", l4="", l5="", l6="") {
    ...
    if (l2 !== ""){
        text_Y_val += 30;
        ctx.fillText(l2, 75, text_Y_val);
    } else return;
    if (l3 !== ""){
        text_Y_val += 30;
        ctx.fillText(l3, 75, text_Y_val);
    } else return;
    if (l4 !== ""){
        text_Y_val += 30;
        ctx.fillText(l4, 75, text_Y_val);
    } else return;
    if (l5 !== ""){
        text_Y_val += 30;
        ctx.fillText(l5, 75, text_Y_val);
    } else return;
    if (l6 !== ""){
        text_Y_val += 30;
        ctx.fillText(l6, 75, text_Y_val);
    } else return;

}

function newBulletPoint(yVal){
    return;
}
